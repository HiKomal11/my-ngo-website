...
export default function Projects() {
  ...
  const fallbackProjects = [
    {
      ...
      image: "https://images.unsplash.com/photo-1588776814546-ec7d3f3f3f3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    },
    {
      title: "Green Initiative",
      description: "Volunteers planting trees for a cleaner tomorrow.",
      image: "https://images.unsplash.com/photo-1509099836639-18ba106728d4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    },
    {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post("http://127.0.0.1:8000/api/participations/", formData)
      .then(() => {
        alert(`Thank you, ${formData.name}! Your interest in ${formData.project} has been recorded.`);
  ...
  return (
    <div className="container py-4">
        ...
        {projects.map((proj, idx) => (
          <div className="col-12 col-md-6 col-lg-4" key={idx}>
            <div className="card h-100 shadow-sm">
              <img src={proj.image} alt={proj.title} className="card-img-top" />
              <div className="card-body">
                <h5 className="card-title">{proj.title}</h5>
                <p className="card-text text-truncate">{proj.description}</p>
                <button
                  type="button"
                ...
                <button
                  ...
                  onClick={() => setFormData({ ...formData, project: proj.title })}
                  data-bs-toggle="modal"
      ...
      {/* Learn More Modal */}
      <div className="modal fade" id="learnMoreModal" tabIndex="-1" aria-hidden="true">
      ...
      {/* Join/Donate Modal */}
      <div className="modal fade" id="joinDonateModal" tabIndex="-1" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content">
