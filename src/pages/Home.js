  ...
  const fallbackCampaigns = [
    {
      ...
      details: "This campaign focuses on building schools, providing books, and training teachers in rural areas."
    },
    {
      ...
      details: "Our mobile vans travel to villages offering free checkups, medicines, and health awareness programs."
    },
    {
      ...
      details: "We provide training in tailoring, computer literacy, and other skills to help secure livelihoods."
    },
  ];
  ...
  return (
    <div className="container py-4">
      ...
      <section className="text-center mb-5">
        <h1 className="display-5 fw-bold">Creating Lasting Impact</h1>
        <p className="lead">
      ...
      {/* Featured Campaigns */}
      <section>
        <h2 className="mb-4 text-center"> Featured Campaigns</h2>
              ...
              {selectedCampaign && (
                <>
                  ...
                  {selectedCampaign.details && (
                    <p><strong>Details:</strong> {selectedCampaign.details}</p>
                  )}
                </>
              )}
            </div>
